...
> **Evidence boundary.** This chapter uses the facts in `main.tex`, the two public arXiv papers, the public Matter SDK documentation, and the public BUET undergraduate-research listing. The private Matter and visual-certificate manuscripts are not present in this workspace. Their undisclosed finding details, exact Visual Proof Gain formula, exact eight graph properties, model versions, splits, and personal task allocation are therefore **not guessed** here. Read those items once from your manuscripts before the viva. Everything else below is a defensible recall framework.

Public references used for facts that are not in `main.tex`:
...
## 12.1 Presidency University — Lecturer
...
## 12.2 SysModeler AI & Systems Innovation Lab — Junior AI Engineer
...
## 12.3 SocioFi Technology — Researcher and AI software developer intern
