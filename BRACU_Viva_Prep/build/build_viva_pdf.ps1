...
$outputName = 'BRACU_CSE_Viva_Slide_Based_Detailed_Ahmmad_Nur_Swapnil.pdf'
$finalOutput = Join-Path $packRoot $outputName
$generatedRoot = Join-Path $packRoot '.generated'

$sourceNames = @(
    'README.md',
    '00_INTERVIEW_TEACHING_INDUSTRY_COMPLETE.md',
    ...
    '07_NETWORKING_SLIDE_COMPLETE.md',
    ...
    '12_COMPUTER_GRAPHICS_SLIDE_COMPLETE.md',
    '13_SECURITY_CORE_COMPLETE.md',
    '14_ARCHITECTURE_DLD_MICRO_CORE_COMPLETE.md',
    '15_TOC_CORE_COMPLETE.md',
...
& pandoc $combinedPath `
    ...
    --toc `
    --toc-depth=3 `
    --metadata='title=Bismillah. BRACU CSE Faculty Viva - Source-Grounded Preparation Pack' `
